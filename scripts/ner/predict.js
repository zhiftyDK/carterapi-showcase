...
let model, emodel;
(async function() {
    model = await tf.loadLayersModel('https://raw.githubusercontent.com/zhiftyDK/carterapi-showcase/main/scripts/ner/model.json?token=GHSAT0AAAAAABUUJQBS3CWFA6YCWRGXBSCQYXQIWMQ');
